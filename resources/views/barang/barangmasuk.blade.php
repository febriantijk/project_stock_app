                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ carbon\carbon::parse($item->tanggal_faktor)->format('d/m/y') }}</td>
                                ...
                                <td class="text-center">{{ $item->getadmin->name}}</tdclass>
                                <td class="text-center">{{ $item->getstok->cabang }}</td>
                                <td class="text-center">
                                    <a
                                        href="{{ url('/barang-masuk') }}/{{$item->id}}"
                                        class="btn btn-danger"
                                        onclick="return confirm('menghapus data dapat menyebabkan beberapa kekelliruan dalam data stok!!!,yakin hapus data?')"
                                        title="Hapus">
                                        <i class="bi-trash"></i>
